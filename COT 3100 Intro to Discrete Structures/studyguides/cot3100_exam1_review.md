...
<p style="text-align:center">
    ...
    <a href="../flashcards/cot3100_exam1_flashcards.csv">flashcards</a> |
...
**Notice:** From student experience, studying the above Quizlet helps tremendously for this exam.

#### **Figure 1.** Logic Symbols and their Meanings
...
<small>\**:* typically comes after $\exists$, and *|* typically comes after $\forall$</small>
...
>**Example 1.** Sets cannot be created from ambiguous conditions.
>
...
#### **Figure 2.** Common Sets of Numbers
...
#### **Figure 3.** Common Logical Operators
...
#### **Figure 5.** Derived Logical Identities
| Name              | Form                                                                                              | Property      |
|:------------------|:--------------------------------------------------------------------------------------------------|:--------------|
...
#### **Figure 6.** Transformations of $p \rightarrow q$
| Name              | Form                  |
|:-----------------:|:----------------------|
| negation          | p $\land$ ~q          |
...
>**Example 2.** Self-referential sentences cannot be given a truth value, so they can never be statements.
>
>"This sentence is true" is not a statement by this logic.

#### **Figure 7.** Types of statements
| Type          | Claim                                     | Example                                                   |
|:-------------:|:------------------------------------------|:----------------------------------------------------------|
...
>**Example 3.** Logical arguments can be converted to their equivalent conditional.
>
...
>**Example 4.** Create a truth table for *x $\land$ ~y + z(~x $\lor$ y)*.
>
...
#### **Figure 9.** Common Rules of Inference
...
#### **Figure 10.** Universal Rules of Inference
| Name                      | Form                                                                                                                                          |
|:--------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------|
